  ...
  render() {
    return (
      <div>
        ...
        <p>
          Studs built the Studieresan app as a Free app. This SERVICE is
          provided by Studs at no cost and is intended for use as is.
        </p>{' '}
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at Studieresan unless
        ...
        <p>This policy is effective as of 2020-12-15</p>{' '}
        <p>
          <strong>Contact Us</strong>
        </p>{' '}
        <p>
          If you have any questions or suggestions about our Privacy Policy, do
          not hesitate to contact us at it@studs.se.
        </p>
      </div>
    )
  }
