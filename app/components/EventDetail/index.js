  ...
  render() {
    ...
    return (
      <div className={styles.eventDetail}>
        ...
        <div>
          <hr/>
          <h2><FormattedMessage {...messages.privateDescription} /></h2>
              ...
              <div>
                {before && before.length ? (
                  <div>
                    ...
                    <button name='before'onClick={this.handleRemindClick} className='btn-default'>
                      Remind on slack
                    </button>
                    }
                    <ul>{before}</ul>
              ...
              <div>
                {after && after.length ? (
                  <div>
                    ...
                    {!event.remindedAfter &&
                    <button name='after' onClick={this.handleRemindClick} className='btn-default'>
                      Remind on slack
                    </button>
                    }
                    <ul>{after}</ul>
