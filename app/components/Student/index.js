      ...
      <div className={styles.container}>
        ...
        <div className={styles.intro}>
          <p>
            ...
            mål. Studs kommer inte att bara ge dig stora kunskaper inom allt vad
          ...
          <div className={styles.group}>
            ...
            <div className={styles.info}>
              <p>
                ...
                tillgodoser de andra gruppernas ekonomiska behov. Arbetet är
        ...
        <div className={styles.group_container}>
          ...
          <div className={styles.group}>
            ...
            <div className={styles.info}>
              <p>
                Eventgruppen ansvarar för planerandet och genomförandet för alla
          ...
          <div className={styles.group}>
            ...
            <div className={styles.info}>
              <p>
                ...
                mobilapplikationerna. De programmeringsspråk som används är
                JavaScript (React, Node), Kotlin (Android) och Swift (iOS). Du
                bör ha ett intresse för programmering och mjukvaruutveckling och
                ett sug efter att lära dig nya saker. Det är ett plus om du har
                tidigare erfarenhet, men det är inget krav. Arbetsbelastningen
                är kontinuerlig under året.
                <br />
          ...
          <div className={styles.group}>
            ...
            <div className={styles.info}>
              <p>
                ...
                Som medlem i resegruppen leder du hela gruppen under resan och
                ser till att alla har det bra och hanterar oförutsägbara
                situationer. Merparten av arbetet sker under hösten.
                <br />
          ...
          <div className={styles.group}>
            ...
            <div className={styles.info}>
              <p>
                ...
                Studs och företag och säljer in event hos företagen. Det är
                viktigt att du som medlem i säljgruppen är utåtriktad och
                social, och inte tappar glöden om du får ett ”Nej tack” från ett
                företag. Säljgruppen jobbar nära flera andra grupper,
                framförallt eventgruppen som tar över efter sälj när ett event
                har blivit sålt. För säljgruppen är det som mest arbete under
                hösten, då majoriteten av vårens event säljs.
                <br />
