...
const RecruitmentHeader = () =>
  <div className={styles.recruitmentHeader}>
    ...
    <div>
      <p className={styles.boldIntro}>Studs är en årlig projektkurs som genomförs av ca 30 masterstudenter med datainriktning. Gemensamt planerar och anordnar vi i projektgruppen företagsevent, som tillsammans finansierar en studieresa under sommaren 20{STUDS_YEAR}. <a href='https://www.kth.se/student/kurser/kurs/AI2151' target="_blank" rel="noopener noreferrer">Kursen (AI2151)</a> är på 15 HP och destinationen för studieresan bestäms gemensamt av projektmedlemmarna.</p>

      <p>De företagsevent som arrangeras under läsåret är obligatoriska för samtliga projektmedlemmar och merparten av dessa event sker under VT{STUDS_YEAR}. Vanligtvis äger eventen rum på kvällen och uppläggen kan skilja sig mellan olika event – totalt ca 30 företagsevent under läsåret. Med detta är Studs en unik chans att knyta värdefulla kontakter inom näringslivet.</p>
